...
def _save(image, base, folder):
    os.makedirs(folder, exist_ok=True)
    image.resize((base, base), Image.LANCZOS).save(
        os.path.join(folder, f'{base}x{base}.png'))
